...
def part_1(lines):
    ...
    nb_sym_row = [sum(land.nb_sym_rows_part_1()) for land in all_lands]
    nb_sym_col = [sum(land.nb_sym_cols_part_1()) for land in all_lands]
...
def part_2(lines):
    ...
    nb_sym_row = [sum(land.nb_sym_rows_part_2()) for land in all_lands]
    nb_sym_col = [sum(land.nb_sym_cols_part_2()) for land in all_lands]
